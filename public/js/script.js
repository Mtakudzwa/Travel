...
document.addEventListener("DOMContentLoaded", async () => {
    const destinationContainer = document.querySelector("#destinations .row");
        ...
        destinationContainer.innerHTML = destinations.map(dest => `
            <div class="col-md-4 mb-4">
                <div class="card overflow-hidden shadow">
                    <img class="card-img-top" src="${dest.image}" alt="${dest.name}" />
                    <div class="card-body py-4 px-3">
                        <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                            <h4 class="text-secondary fw-medium">
                                <a class="link-900 text-decoration-none stretched-link" href="#" onclick="confirmLogin(event)">${dest.name}</a>
                            </h4>
                            <span class="fs-1 fw-medium">${dest.price}</span>
                        </div>
                        <div class="d-flex align-items-center">
                            <span class="fs-0 fw-medium">${dest.duration}</span>
                        </div>
                    </div>
                </div>
            </div>
